...
# Default values (Values from Frosted Glass v1.2.2)
DEFAULT_LIGHT_PRIMARY = [106, 116, 211]   # Purple
DEFAULT_LIGHT_TEXT = [19, 21, 54]         # Dark Blue-Grey
...
DEFAULT_DARK_PRIMARY = [106, 116, 211]    # Purple
DEFAULT_DARK_TEXT = [234, 235, 238]       # White-ish
...
# Template - 1:1 Copy of Frosted Glass v1.2.2 with placeholders
THEME_TEMPLATE = """
  ...
  modes:
    light:
      ...
      card-mod-card: |
        ...
        /* === FIX: Navbar Card - Force transparency === */
      ...
      card-mod-root: |
       ...
       custom-text-divider-row .text-divider-content {
        ...
        .mdc-drawer .mdc-drawer__content {
          ...
          background: rgba(254, 244, 242, 0.7) !important;
        ...
        ha-label-badge {
          ...
          --label-badge-text-color: rgba(__LIGHT_TEXT_RGB__, 0.9) !important;
      ...
      ha-color-primary-50: '__LIGHT_PRIMARY_HEX__'   # base theme primary (kept)
      ...
      color-primary-50: '__LIGHT_PRIMARY_HEX__'
      ...
      mdc-checkbox-unchecked-color: 'rgba(__LIGHT_TEXT_RGB__, 0.75)'
      mdc-radio-unchecked-color: 'rgba(__LIGHT_TEXT_RGB__, 0.75)'
      ...
      input-ink-color: 'rgba(__LIGHT_TEXT_RGB__, 0.98)'
      input-label-ink-color: 'rgba(__LIGHT_TEXT_RGB__, 0.98)'
      input-disabled-fill-color: 'rgba(245, 245, 245, 0.6)'
      input-disabled-ink-color: 'rgba(__LIGHT_TEXT_RGB__, 0.45)'
      input-disabled-label-ink-color: 'rgba(__LIGHT_TEXT_RGB__, 0.45)'
      input-idle-line-color: 'transparent'
      input-dropdown-icon-color: 'rgba(__LIGHT_TEXT_RGB__, 0.8)'
      ...
      codemirror-meta: 'rgba(__LIGHT_TEXT_RGB__, 0.98)'
    ...
    dark:
      ...
      ha-color-primary-30: '#30345F'
      ha-color-primary-40: '#40467F'
      ha-color-primary-50: '__DARK_PRIMARY_HEX__'   # base theme primary (kept)
      ha-color-primary-60: '#8F97DE'
      ha-color-primary-70: '#ADB3E7'
      ha-color-primary-80: '#D2D5F2'
      ha-color-primary-90: '#EAECF9'
      ...
      color-primary-30: '#30345F'
      color-primary-40: '#40467F'
      color-primary-50: '__DARK_PRIMARY_HEX__'
      color-primary-60: '#8F97DE'
      color-primary-70: '#ADB3E7'
      color-primary-80: '#D2D5F2'
      color-primary-90: '#EAECF9'
      ...
      dark-primary-color: 'rgb(__DARK_PRIMARY_RGB__)'
      light-primary-color: 'rgb(167, 182, 199)'
