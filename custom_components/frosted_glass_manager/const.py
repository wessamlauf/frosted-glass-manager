...
# Default values (Pôvodná Fialová)
...
# Placeholders:
# __LIGHT_PRIMARY_RGB__  -> "106, 116, 211"
# __LIGHT_PRIMARY_HEX__  -> "#6A74D3"
# __LIGHT_BG__
# (Text colors are HARDCODED back to original theme defaults)
  ...
  modes:
    light:
      ...
      card-mod-card: |
        ...
        /* === Prevent frosted/glass on mushroom-chips-card outer container === */
      ...
      card-mod-root: |
       :host {
        ...
        /* Tokens (Dynamic) - MOVED INSIDE :HOST */
       ...
       /* Custom text divider row size fix - OUTSIDE HOST */
