...
DEFAULT_PRIMARY_COLOR = "#6A74D3"
DEFAULT_ACCENT_COLOR = "#6A74D3"

# Názov vygenerovaného súboru v priečinku themes
THEME_FILENAME = "frosted_glass_custom.yaml"

# Šablóna témy.
# Python nahradí __PRIMARY_RGB__ a __PRIMARY_HEX__ za hodnoty z nastavení.
THEME_TEMPLATE = """
...
Frosted Glass Custom:
  ...
  card-mod-root: |
    :host {
      ...
      /* Tokens - Dynamic Colors */
      --token-rgb-primary: __PRIMARY_RGB__;
      ...
      --token-rgb-cyan: __PRIMARY_RGB__;
      --token-rgb-teal: __PRIMARY_RGB__;
      ...
      --token-color-feedback-info: rgb(__PRIMARY_RGB__);
  ...
  primary-color: 'rgb(__PRIMARY_RGB__)'
  dark-primary-color: 'rgb(__PRIMARY_RGB__)'
  light-primary-color: 'rgb(167, 182, 199)'
  accent-color: 'rgb(__PRIMARY_RGB__)'
  divider-color: 'rgba(84, 84, 98, 0.28)'
  scrollbar-thumb-color: 'rgb(68, 68, 88)'
  disabled-color: 'rgb(173, 176, 184)'
  info-color: 'rgb(__PRIMARY_RGB__)'
  ...
  navbar-background-color: 'transparent' # Overridden in card-mod-card for specificity

  # Sliders, toggles, switches
  paper-slider-knob-color: 'rgb(__PRIMARY_RGB__)'
  paper-slider-knob-start-color: 'rgb(__PRIMARY_RGB__)'
  paper-slider-pin-color: 'rgb(__PRIMARY_RGB__)'
  paper-slider-active-color: 'rgb(__PRIMARY_RGB__)'
  paper-slider-secondary-color: 'rgb(167, 182, 199)'
  switch-checked-button-color: 'rgb(__PRIMARY_RGB__)'
  switch-checked-track-color: 'rgb(__PRIMARY_RGB__)'
  switch-unchecked-button-color: 'rgba(234, 235, 238, 0.3)'
  switch-unchecked-track-color: 'rgba(234, 235, 238, 0.18)'
  paper-toggle-button-checked-button-color: 'rgb(__PRIMARY_RGB__)'
  paper-toggle-button-checked-bar-color: 'rgb(__PRIMARY_RGB__)'
  ...
  input-hover-line-color: 'rgb(__PRIMARY_RGB__)'
  ...
  codemirror-property: 'rgb(__PRIMARY_RGB__)'
  codemirror-atom: 'rgb(__PRIMARY_RGB__)'
